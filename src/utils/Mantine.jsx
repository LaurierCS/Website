...
const mantineTheme = {
    ...
    colors: {
        ...
        blue: ['#dcf2ff', '#afdbff', '#82c7fb', '#52b7f7', '#29abf4', '#0b82da', '#0059ab', '#00387b', '#001c4d', '#00071f'],

        // the light blue we have in css variable (--color-light-blue) is index 2
        lightBlue: ['#dff6ff', '#b6e2fa', '#a1daf5', '#61b5ed', '#3a96e7', '#2572cd', '#184fa0', '#0c3073', '#001547', '#00041c'],

        // the pink solely exists for the sake of the blue-pink gradient
        pink: ['#ffe2fb', '#ffb1eb', '#ff7fdf', '#ff4dd8', '#fe1ebd', '#e50795', '#b30067', '#810041', '#4f0023', '#1e000b'],

        // all the gray shades are good to use but preferably indeces: 0, 4, 5, 7, 8, 9 
        gray: ["#F8F8F8", "#F1F3F5", "#E9ECEF", "#DEE2E6", "#E7EBF5", "#B2BECD", "#868E96", "#454E56", "#2C3844", "#12181B"],
    },
    primaryColor: 'blue',
    primaryShade: {
        light: 4,
